 ...
 *
 * @note
 * Relation inherits the methods of QueryBuilder.
 */
 ...
 */
Relation.prototype.first = function(cb) {
...
/**
 * Executes a query returning raw result.
 *
 * Use `all` if you want result.rows.
 */
      ...
      relation.all(function(err, relationRows) {
        ...
        _.each(rows, function(row) {
          ...
          if (filtered.length > 0) {
            // remove __id field which was used to correlate child rows
